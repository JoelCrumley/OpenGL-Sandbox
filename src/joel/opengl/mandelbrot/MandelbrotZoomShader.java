...
public class MandelbrotZoomShader extends MandelbrotShaderAbstract {
...
//    private static final String FRAGMENT_FILE = "src/res/shaders/fragMandelbrotDoubles.txt";
    ...
    public MandelbrotZoomShader(int width, int height, double x, double y, double zoom, float limit, int iterations, int colourMode, boolean showCrosshair) {
