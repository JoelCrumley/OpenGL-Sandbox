...
public class Loader {
    ...
    private static final List<OldTexture> textures = new ArrayList<>();
...
//    }
    ...
    public static void cleanUp(){
        ...
        for (OldTexture texture : textures) texture.cleanUp();
    }
    ...
    public static OldTexture loadTexture(String path) {
        ByteBuffer image;
        int width, height;
...
//            image = stbi_load(RESOURCES_DIR + path, w, h, comp, 4);
        ...
        OldTexture texture = new OldTexture(width, height, image);
